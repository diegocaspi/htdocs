    ...
    <center>
        <div class="container">
            <div class="form-group w-50">
                ...
                <input type="text" id="email" class="form-control" name="email" placeholder="Insert email">
            </div>
            <br> <br>
            <div class="form-group w-50">
...
<a class="btn btn-outline-primary" href="/MVC_todo/login/admin">Go to admin login</a>