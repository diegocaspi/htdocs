<script>
    ...
    function populateLivesearchDiv(json) {
        ...
        json.forEach(task => {
            ...
            a.innerText = task['id'] + ' - ' + task['title'];
    ...
    function showResult(str) {
        ...
        xmlhttp.open("GET", "http://127.0.0.1/MVC_todo/subtasks/livesearch/" + str, true);
        xmlhttp.send();
    }
</script>
...
<form method='post' action=''>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" onkeyup="showResult(this.value)" id="task_id" placeholder="Enter task" name="task_id">
    </div>
    <div id="livesearch" class="list-group"></div>
    <div class="mx-auto" style="height: 20px;"></div>
    <button type="submit" class="btn btn-primary">Submit</button>
    <a class="btn btn-info btn-xs" href="/MVC_todo/tasks/create/">Create task</a>
</form>